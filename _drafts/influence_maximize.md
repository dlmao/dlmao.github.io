...
Intuitively, when {% raw %} $$K=1$$  {% endraw %}, we should choose the vertex that has the most connections, i.e the user who has the most friends.
...
The question now becomes what happens when we want to maximize influence in our network for choosing more than one vertex.
