...
This influence found by this algorithm is guaranteed to be:

{% raw %} $$I(S)=[1-(1-\frac{1}{K})^{i+1}]I(Optimal)$$ {% endraw %}

where {% raw %} $$I(Optimal)$$ {% endraw %} is the optimal solution. We can see in the case that {% raw %} $$K=1$$ {% endraw %}, our solution is guaranteed optimal, as we oberved from the earlier section.
